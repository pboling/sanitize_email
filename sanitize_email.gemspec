...
Gem::Specification.new do |s|
  ...
  s.files = ["VERSION.yml", "lib/sanitize_email", "lib/sanitize_email/custom_environments.rb", "lib/sanitize_email/sanitize_email.rb", "lib/sanitize_email.rb", "test/sanitize_email_test.rb"]
  s.has_rdoc = true

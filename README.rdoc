...
NOTE: This example is outdated.  This functionality is not yet in the 1.0.0.* line of code.

So here's how you can use force_sanitize to override the override.

Even if you set (this usage is now deprecated - please use :local_environment_proc instead):
